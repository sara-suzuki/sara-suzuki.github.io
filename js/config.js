...
const CONFIG = {
  ...
  about: {
    ...
    bio: [
      ...
      "I currently work as a Senior Researcher at <a href='https://circle.tufts.edu/' target='_blank' rel='noopener'>CIRCLE</a>, a non-partisan research center that is part of the Tisch College of Civic Life at Tufts University. For AY 2026-2027, I am also a Democracy Fellow at the <a href='https://ash.harvard.edu/' target='_blank' rel='noopener'>Ash Center for Democratic Governance and Innovation</a> at the Harvard Kennedy School. I received my Ph.D. in Applied Developmental and Educational Psychology from Boston College."
    ],
